package com.munditv.alarsctest;
 ...
 * AlaRSCTestActivity
 */
public class AlaRSCTestActivity extends Activity implements BluetoothAdapter.LeScanCallback {
    private static final String TAG = "RSCTestActivity";

    private static final String DEVICE_NAME = "UMHD";
    ...
    private static final UUID UUID_CUSTOMER_DEF01 = getUUID_TI("ff10");
    private static final UUID UUID_CUSTOMER_DEF02 = getUUID_TI("ff11");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        for (int i=0; i < mDevices.size(); i++) {
            ...
            menu.add(0, mDevices.keyAt(i), 0, device.getAddress());
        }
    ...
    public void sendNotify() {
        BluetoothGattCharacteristic chara, chara1;
        BluetoothGattDescriptor desc , desc1;
       ...
       @Override
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
        	...
        	if(characteristic.getUuid().equals(UUID_UMEDIA_KEYPAD_CHARACTERISTICS)) {
        		Log.d(TAG, "Umedia KeyPad Changed");
        		keyval = characteristic.getIntValue( BluetoothGattCharacteristic.FORMAT_UINT8, 0);
        		Log.d(TAG, "Umedia KeyPad Changed code = " + keyval );
        		//Toast.makeText(myContext, Integer.toString(code), 3);
